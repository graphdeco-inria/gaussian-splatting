...
for scene in "${all_scenes[@]}"; do
    bash srun_sub.sh $scene mcmc-eval
    bash srun_sub.sh $scene mcmc_no_density-eval
    ...
    bash srun_sub.sh $scene sophia_hellinger_no_densify_update10-eval
    bash srun_sub.sh $scene sophia_hellinger_no_densify_abs_update10-eval
    ...
    bash srun_sub.sh $scene sophia_hellinger_no_densify_normrot-eval
    bash srun_sub.sh $scene sophia_hellinger_no_density_abs_normrot-eval
    bash srun_sub.sh $scene adam_tr_no_densify-eval
done