...
TASKS_DIR=${TASKS_DIR:-./data/task_outputs_10w}
OUTPUT_DIR=${OUTPUT_DIR:-./data1/10w_fpv}
...
PARALLEL_REPORT_DIR=${PARALLEL_REPORT_DIR:-./parallel_render_report_fpv.json}
ERROR_LOG=${ERROR_LOG:-./10w_fpv.log}
