...
do
    ...
    python train.py -s ${colmap_path_augmented}/${scene} -m ${exp_path}/360_augmented_corr/${scene} \
    -i images_4 \
    --eval \
    --bundle_training \
    ...
    python render.py -m ${exp_path}/360_augmented_corr/${scene} --skip_train

    python metrics.py -m ${exp_path}/360_augmented_corr/${scene}
done
