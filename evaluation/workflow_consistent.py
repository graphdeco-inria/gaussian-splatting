...
def compute_iou_for_beta(beta, scene_id, class_name, gt_id, output_base, class_output_dir, gt_mesh, full_model, gt_iou_val):
    """
...
def evaluate_object(scene_id, class_name, yolo_id, available_labels, reuse_voting=False, alpha=1.0, size_penalty=100.0, betas=[0.01, 0.02]):
    ...
    for i, gt_id in enumerate(final_candidates):
        ...
        iou_03 = compute_iou_for_beta(0.03, scene_id, class_name, gt_id, output_base, class_output_dir, gt_mesh, gaussian_ply, gt_iou_val)
        ...
        if iou_03 > 0.05:
            ...
            for b in betas:
                iou_b = compute_iou_for_beta(b, scene_id, class_name, gt_id, output_base, class_output_dir, gt_mesh, gaussian_ply, gt_iou_val)
